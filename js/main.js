// On attend que tout le HTML soit chargé avant de toucher au DOM
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!canvas) {
    console.error("Canvas #space introuvable.");
    return;
  }
  ...
  window.backdropClick = function (event) {
 ...
 function handleGoogleLogin() {
  ...
  // Invité : on ferme la modale, on passe en mode “invité”
  ...
  // on connecte les boutons (si présents)
  ...
  window.backdropLegalClick = function (e) {
